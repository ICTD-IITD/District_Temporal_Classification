...
for indicator in l :
    y = final_2011[[indicator+"_2011"]]
    clf = XGBClassifier()
    clf.fit(X_2011, y.values.ravel())
    y_pred = clf.predict(X_2001)
    #print(final_2001[indicator+"_2001"].shape,y_pred.shape)
    print(indicator," => ",f1_score(final_2001[indicator+"_2001"].values.ravel(),y_pred, average='weighted'))
